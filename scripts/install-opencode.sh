#!/usr/bin/env bash
# Copied from https://raw.githubusercontent.com/anomalyco/opencode/v1.18.18/install 
# To update: download the latest release tag's install script and replace this file
set -euo pipefail
APP=opencode
